-- TaskField cloud sync — run ONCE in the Supabase dashboard SQL editor.
-- Creates a per-user state table with Row-Level Security so each account
-- can only read/write its own data.
